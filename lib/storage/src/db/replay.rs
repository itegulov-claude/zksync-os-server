...
impl ReadReplay for BlockReplayStorage {
    ...
    fn get_replay_record_by_key(
        ...
        Some(ReplayRecord {
            ...
            .expect("Failed to deserialize context")
            .0,
            last_interop_event_index: bincode::serde::decode_from_slice(
